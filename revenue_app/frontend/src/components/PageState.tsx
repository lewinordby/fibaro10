...
export function Loading() {
  return <div className="flex min-h-96 flex-col items-center justify-center gap-3 text-gray-400 dark:text-gray-500"><MosaicIcon name="refresh" className="animate-spin" size={28} /><strong className="text-sm">Henter omsetningsdata</strong></div>;
}
