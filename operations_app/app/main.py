...
DOMAIN_PATTERN = re.compile(r"(?:actions/(?:ventilasjon|lys|dorer|solrom|pullerter|renhold)|operations/overview|unifi-protect/bollards|renhold/(?:robots|night-report|cleaning-profiles)|ventilation|lights?|doors?|solrooms?|bollards?|roborock|hc3)(?:/.*)?")
