...
DOMAIN_PATTERN = re.compile(r"(?:actions/(?:ventilasjon|lys|dorer|solrom|pullerter|renhold)|operations/overview|unifi-protect/bollards|renhold/(?:robots|night-report|weekly-jobs|water-report|refill-log|cleaning-profiles)|ventilation|lights?|doors?|solrooms?|bollards?|roborock|hc3)(?:/.*)?")
...
app = create_domain_app(
    DomainAppConfig(
        ...
        app_dir=APP_DIR,
        port=8155,
        pwa_description="Byggdrift, ventilasjon, lys, dører, pullerter og renhold for Lilletorget.",
