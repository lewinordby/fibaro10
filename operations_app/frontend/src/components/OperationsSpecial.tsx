...
import { Chart, MosaicIcon, Panel, mosaicChartColors, nok, useAppSearchParams, type MosaicChartConfig } from "@lilletorget/microapp-ui";
import type { JsonRecord, ModuleResponse } from "@lilletorget/microapp-ui/types";
import type { ControlSettings, SettingsData, VentilationData } from "../types";
...
export function VentilationSpecial({ data, view, reload }: { data: ModuleResponse; view: string; reload: () => void }) {
  const ventilation = data.ventilation as unknown as VentilationData | null | undefined;
