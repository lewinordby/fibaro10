...
SYSTEM_COMPONENTS: list[dict[str, Any]] = [
    {
        "component": "fibaro10",
        "area": "Kjerne",
        "role": "FastAPI-kjerne, database, autentisering og API-er for aktive apper og datatjenester",
        "runtime": "Docker",
        "compose_service": "fibaro10",
        "interface": "Internt API",
        "web_url": "",
        "local_url": "",
    ...
    },
    {
        ...
        "area": "Frontend",
        "role": "Gjeldende brukerflate med tretten Mantis-mikroapper under én HTTPS-origin",
    ...
    {
        "component": "lilletorget_kiosk",
        "area": "Frontend",
        "role": "Fast statusflate for robotrenhold på 1920 x 1080-skjerm",
        "runtime": "Docker / Nginx",
        "compose_service": "lilletorget_kiosk",
        "interface": "Kiosk web/PWA",
        "web_url": "https://kiosk.lilletorget.net/",
        "local_url": "http://192.168.20.218:8163/",
        "health_url": "http://192.168.20.218:8163/health",
        "health": "/health",
        "status": "Aktiv",
        "criticality": "Normal",
        "has_web_interface": True,
    },
    {
        ...
        "area": "Økonomi",
        "role": "API-adapter mellom Mantis og kjernen for omsetningsdata",
        "runtime": "Docker",
        "compose_service": "revenue_app",
        "interface": "Internt API-adapter",
        "web_url": "",
        "local_url": "",
    ...
    },
    {
        ...
        "area": "Parkering",
        "role": "API-adapter mellom Mantis og kjernen for parkering",
        "runtime": "Docker",
    ...
    },
    {
        "component": "sun_app",
        "area": "Soling",
        "role": "API-adapter mellom Mantis og kjernen for soling og solbilder",
        "runtime": "Docker",
    ...
    },
    {
        ...
        "area": "Energi",
        "role": "API-adapter mellom Mantis og kjernen for energi",
        "runtime": "Docker",
    ...
    },
    {
        ...
        "area": "Bygg og drift",
        "role": "API-adapter mellom Mantis og kjernen for bygg, renhold og kontroll",
        "runtime": "Docker",
    ...
    },
    {
        ...
        "area": "Vedlikehold",
        "role": "API-adapter mellom Mantis og kjernen for vedlikehold",
        "runtime": "Docker",
    ...
    },
    {
        ...
        "area": "System",
        "role": "API-adapter mellom Mantis og kjernen for system og dokumentasjon",
        "runtime": "Docker",
    ...
    },
    {
        "component": "link_app",
        "area": "Kobling",
        "role": "API-adapter mellom Mantis og kjernen for koblingsmotoren",
        "runtime": "Docker",
...
SYSTEM_COMPONENT_TITLES: dict[str, str] = {
    ...
    "lilletorget_kiosk": "Renhold kiosk",
