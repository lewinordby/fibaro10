...
REVENUE_APP_URL = os.getenv("REVENUE_APP_URL", "https://omsetning.lilletorget.net:8443").rstrip("/")
PARKING_BASE_URL = os.getenv("PARKING_BASE_URL", "http://parking_app:8152").rstrip("/")
PARKING_APP_URL = os.getenv("PARKING_APP_URL", "https://parkering.lilletorget.net:8443").rstrip("/")
SUN_BASE_URL = os.getenv("SUN_BASE_URL", "http://sun_app:8153").rstrip("/")
SUN_APP_URL = os.getenv("SUN_APP_URL", "https://soling.lilletorget.net:8443").rstrip("/")
ENERGY_BASE_URL = os.getenv("ENERGY_BASE_URL", "http://energy_app:8154").rstrip("/")
ENERGY_APP_URL = os.getenv("ENERGY_APP_URL", "https://energi.lilletorget.net:8443").rstrip("/")
OPERATIONS_BASE_URL = os.getenv("OPERATIONS_BASE_URL", "http://operations_app:8155").rstrip("/")
OPERATIONS_APP_URL = os.getenv("OPERATIONS_APP_URL", "https://drift.lilletorget.net:8443").rstrip("/")
MAINTENANCE_BASE_URL = os.getenv("MAINTENANCE_BASE_URL", "http://maintenance_app:8156").rstrip("/")
MAINTENANCE_APP_URL = os.getenv("MAINTENANCE_APP_URL", "https://vedlikehold.lilletorget.net:8443").rstrip("/")
SYSTEM_BASE_URL = os.getenv("SYSTEM_BASE_URL", "http://system_app:8157").rstrip("/")
SYSTEM_APP_URL = os.getenv("SYSTEM_APP_URL", "https://system.lilletorget.net:8443").rstrip("/")
LINK_BASE_URL = os.getenv("LINK_BASE_URL", "http://link_app:8158").rstrip("/")
LINK_APP_URL = os.getenv("LINK_APP_URL", "https://koble.lilletorget.net:8443").rstrip("/")
