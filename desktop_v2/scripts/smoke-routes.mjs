export const smokeRoutes = [
  ...
  { path: "/solrom/oversikt", name: "Solrom na", expectedTexts: ["Solrom nå", "I bruk", "Forventet ut"] },
  { path: "/solrom/dagskontroll", name: "Solrom dagskontroll", expectedTexts: ["Solrom · dagskontroll", "Dato", "Hendelse"] },
  { path: "/solrom/rom", name: "Solrom romdetalj" },
  { path: "/solrom-2/oversikt", name: "Solrom-2 na", expectedTexts: ["Solrom-2", "Romstatus"] },
  { path: "/solrom-2/dagskontroll", name: "Solrom-2 dagskontroll", expectedTexts: ["Dagskontroll", "Dagsmatrise"] },
  { path: "/solrom-2/avvik", name: "Solrom-2 avvik", expectedTexts: ["Avvik og kontroll", "Kritiske"] },
  { path: "/solrom-2/rom", name: "Solrom-2 romdetalj" },
  { path: "/dorer2/oversikt", name: "Dorer2 situasjon", expectedTexts: ["Dører2", "situasjon", "Romkart"] },
  { path: "/dorer2/rom", name: "Dorer2 romdetalj" },
  { path: "/dorer2/bygg", name: "Dorer2 byggdorer", expectedTexts: ["Byggdører", "Avvik"] },
  ...
  { path: "/dorer/avvik", name: "Dorer avvik", expectedTexts: ["Dørperioder mot Sun2", "Alarm"] },
  ...
  { path: "/undersystemer/oversikt", name: "System undersystemer", expectedTexts: ["Undersystemer", "Fibaro10 reservegrensesnitt", "Vedlikehold mobil", "OwnTracks"] },
  { path: "/manual/oversikt", name: "Manual oversikt", expectedTexts: ["Lilletorget manual", "Undersider"] },
