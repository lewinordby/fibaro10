...
function labelize(column: string): string {
  const labels: Record<string, string> = {
    ...
    sun2_id: "SUN2-ID",
    sun2Id: "SUN2-ID",
    sun2VehicleCount: "Biler mot SUN2",
    assessment: "Vurdering",
    min_matches: "Sterk fra treff",
    max_minutes: "Maks min etter parkering",
    recent_days: "Bilutvalg dager (0 = alle)",
    idle_sleep_seconds: "Pause ajour sek",
    matches_count: "Treff",
    matchesCount: "Soltreff",
    parking_match_count: "Parkeringstreff",
    parkingMatchCount: "Parkeringer med soltreff",
    match_days_count: "Treffdager",
    matchDaysCount: "Treffdager",
    plate_candidate_count: "Alternativer bil",
    sun2_candidate_count: "Alternativer SUN2",
    competitor_matches_count: "Beste konkurrent",
    first_match_at: "Første treff",
    last_match_at: "Siste treff",
    avg_delta_minutes: "Snitt min",
    avgDeltaMinutes: "Snitt min",
    parkingWithoutSunCount: "Parkering uten soltreff",
    parkingMatchShare: "Andel med soltreff %",
    parking_start_at: "Parkering start",
    sun_started_at: "Soltime start",
    delta_minutes: "Diff min",
    sun_session_id: "Soltime-ID",
    ...
    last_received_at: "Mottatt",
    last_lat: "Lat",
    last_lon: "Lon",
    last_accuracy_m: "Nøyaktighet m",
    last_battery_percent: "Batteri %",
    last_connection: "Tilkobling",
    last_event: "Hendelse",
    waypoint_name: "Sone",
    entered_at: "Kom inn",
    left_at: "Dro ut",
    duration: "Varighet",
    source_message_type: "Meldingstype",
    confidence: "Tillit %",
    radius_m: "Radius m",
    start_distance_m: "Start avstand m",
    end_distance_m: "Slutt avstand m",
    start_accuracy_m: "Start nøyaktighet m",
    end_accuracy_m: "Slutt nøyaktighet m",
    received_at: "Mottatt",
    message_type: "Type",
    accuracy_m: "Nøyaktighet m",
    battery_percent: "Batteri %",
    ...
    power_profile: "Effektprofil",
    min_power_w: "Minimum W",
    max_power_w: "Maksimum W",
    fibaro_device_id: "HC3-enhet",
    fibaro_meter_id: "HC3-måler",
    active: "Aktiv",
    site_visit: "Besøk",
    site_visit_id: "Besøks-ID",
    source_visit_id: "OwnTracks-ID",
    location_name: "Sted",
    duration_seconds: "Varighet sek",
    tasks_count: "Oppgaver",
    last_synced_at: "Sist synket",
    enter_source: "Kom-kilde",
    leave_source: "Dro-kilde",
    performed_at: "Utført",
