    ...
    series: [
      {
        ...
        lineStyle: { color: primaryColor, width: chartSeriesLineWidth(true) },
        areaStyle: { color: primaryColor, opacity: chartAreaOpacity(true) },
      ...
      },
      {
        ...
        lineStyle: { color: comparisonColor, width: chartSeriesLineWidth(), type: "dashed" },
        emphasis: { focus: "series" },
      ...
      ...references.map((reference, index) => ({
        ...
        step: "end",
        symbol: "none",
        lineStyle: { color: referenceSeriesColors[index], width: chartSeriesLineWidth(), type: "dotted" },
        emphasis: { focus: "series" },
