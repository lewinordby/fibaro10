export const queryKeys = {
  ...
  systemNotifications: () => ["system", "notifications"] as const,
  systemSubsystems: () => ["system", "subsystems"] as const,
  mobileScreens: () => ["mobile", "screens"] as const,
  bollardOverview: () => ["unifi-protect", "bollards", "overview"] as const,
  ...
  parkingWeeklyYearComparison: (years = "") => ["parking", "weekly-averages", "years", years] as const,
