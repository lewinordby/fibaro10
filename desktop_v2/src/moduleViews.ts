...
export const MODULE_COLORS: Record<string, string> = {
  ...
  biler: "var(--domain-cars)",
  pullerter: "var(--domain-building)",
  ...
  varslinger: "var(--domain-revenue)",
  undersystemer: "var(--domain-manual)",
...
export const MODULE_VIEWS: Record<string, ModuleView[]> = {
  ...
  biler: [{ key: "oversikt", label: "Dagsoversikt" }],
  pullerter: [{ key: "oversikt", label: "Kontroll" }],
  soling: [
    { key: "oversikt", label: "Oversikt" },
    { key: "sammenligning", label: "Årssammenligning" },
    { key: "dagslinje", label: "Dagslinje" },
  ...
  dorer2: [
    { key: "oversikt", label: "Situasjon" },
    { key: "rom", label: "Romdetalj", hidden: true },
    { key: "bygg", label: "Byggdører" },
  ],
  koble: [
    { key: "oversikt", label: "Oversikt" },
  ...
  dorer: [
    { key: "oversikt", label: "Oversikt" },
    { key: "oversikt-ny", label: "Oversikt - ny" },
    { key: "romkontroll", label: "Romkontroll" },
  ...
  varslinger: [{ key: "oversikt", label: "Oversikt" }],
  undersystemer: [{ key: "oversikt", label: "Oversikt" }],
  ideer: [
    { key: "oversikt", label: "Oversikt" },
