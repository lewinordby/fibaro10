...
Oppdatert 12.07.2026, build 1541.
...
| Dører | `/dorer/solrom-ny` | Solrom, andre dører, åpne/lukke-historikk, datovelger, dagskontroll, hendelser per rom og soltimekobling. |
