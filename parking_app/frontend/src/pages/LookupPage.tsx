        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full dark:text-gray-300">
            <thead className="bg-gray-50 text-xs uppercase text-gray-400 dark:bg-gray-700/50 dark:text-gray-500">
              <tr><th className="px-4 py-3 text-left">Reg.nr.</th><th className="px-4 py-3 text-left">Navn</th><th className="px-4 py-3 text-left">Område</th><th className="px-4 py-3 text-right">Parkeringer</th><th className="px-4 py-3 text-left">Sist sett</th></tr>
            </thead>
            <tbody className="divide-y divide-gray-100 text-sm dark:divide-gray-700/60">
              ...
              {!rows.length ? <tr><td className="px-5 py-10 text-center text-gray-400" colSpan={5}>Ingen kjøretøy mangler {fieldLabel.toLowerCase()}.</td></tr> : null}
            </tbody>
          </table>
        </div>
