...
import { Chart as ChartJS, registerables, type ChartConfiguration, type ChartDataset, type Point } from "chart.js";
...
export function Chart({ config, height = 360 }: { config: MosaicChartConfig; height?: number }) {
  ...
  useEffect(() => {
    ...
    const chart = new ChartJS(canvas.current, chartConfig);
