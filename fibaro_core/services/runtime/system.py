        ...
        economy_areas = [
            {
                ...
                "canSee": [
                    ...
                    "registrerte dager og siste vellykkede import per kilde i månedsoversikten; en tom dag er ikke automatisk importfeil",
                ],
            ...
            },
            {
                ...
                "canSee": [
                    ...
                    "betalingskontroll av observert tidsrom: full eller delvis dekning, ukjent sluttid og ventende import; observasjoner beviser ikke sammenhengende parkering",
                ],
        ...
        operations_areas = [
            {
                ...
                "canSee": ["inntak, varmepumper, belysning, massasje, annet og diff", "kurser og målere", "Elvia mot HC3", "forbruk per seng", "23/25-timersdøgn, estimerte Elvia-timer og HC3-tellerreset; tvetydig vintertid utelates fra avvik"],
            ...
            },
            {
                ...
                "canSee": ["status for alle roboter", "planlagte og gjennomførte jobber", "batteri, vann, dokk og forbruksdeler", "kommende nattjobber med vannpauser og kontrollbehov; dette er status nå, ikke en garanti for fullføring"],
            ...
            },
            {
                ...
                "tone": "admin",
                "path": "/operasjon/",
                "purpose": "Arbeidskø og historikk er hendelser som skal behandles. Kontroller viser kontrollreglene. Tekniske datakilder og varslingsabonnementer administreres i System.",
        ...
        system_areas = [
            {
                ...
                "tone": "manual",
                "path": "/system/manual",
                "purpose": "Søkbar kapitteloversikt med forklaring av hovedområder, datakilder, rutiner og feilsøking. Kapitlene åpnes fra manualen; eksisterende direkte kapittellenker fungerer fortsatt.",
        ...
        return {
            ...
            "chapters": [
                ...
                },
                {
                    ...
                    "note": "Menyvalgene er organisert etter fagområde. Operasjon er arbeidskø for avvik, System er teknisk administrasjon. Datakvalitet i en fagapp gjelder dens tall, mens System/Datakilder viser innhenting og feil i kilden. Rapportkatalogen peker til fagrapportene og erstatter dem ikke.",
                },
                ...
                {"id": "bygg-drift", "number": "05", "title": "Bygg og drift", "areas": operations_areas},
                {
                    ...
                    "areas": system_areas,
                    "subapps": [
                        {"title": "Batterier", "text": "Batterinivå for sensorer og brytere i HC3, inkludert Netatmo, samlet per fysisk enhet. Rom, funksjon og HC3-ID gjør enheten lettere å finne. Erstattede følere merkes; uklar plassering må avklares før batteribytte. Robotbatterier finnes under Renhold. Lavt er 20 % eller mindre, kritisk lavt er 10 % eller mindre. Z-Wave-kode 255 er batterivarsel, ikke prosent. HC3 oppgir ikke batterimålingens tidspunkt; kontrolltid er kun når lagrede verdier ble lest. Siden endrer ikke alarmregler eller styring.", "path": "/system/batterier"},
