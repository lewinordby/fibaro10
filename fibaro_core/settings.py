...
SUNROOM_BED_STATUS_MAX_AGE_MINUTES = max(
    5,
    int(os.getenv("SUNROOM_BED_STATUS_MAX_AGE_MINUTES", "10")),
)
...
HC3_DOOR_STATUS_POLL_INTERVAL_SECONDS = max(60, int(os.getenv("HC3_DOOR_STATUS_POLL_INTERVAL_SECONDS", "300")))
