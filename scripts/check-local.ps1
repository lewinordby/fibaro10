...
Run "python" @("-m", "py_compile", "main.py", "build_log.py", "api_contracts.py", "migration_runner.py", "observability.py", "security.py", "roborock_domain.py", "time_formatting.py", "scripts/run-migrations.py") $repoRoot
