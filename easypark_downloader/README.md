...
For mer forutsigbar drift kan `EASYPARK_RUN_TIMES` brukes i stedet for enkelt-tidspunkt/intervall, for eksempel `03:00,12:00,15:00,18:00,21:00`. `EASYPARK_FORCE_LOGIN_TIMES` bør normalt stå tom. EasyPark kan stoppe automatisert bestilling av e-postkode med reCAPTCHA, og derfor er det mest robust å beholde samme browser-session så lenge den fungerer. Hvis EasyPark krever ny manuell verifisering, vises dette tydelig som egen datakildefeil.
